...
export default function Home() {
  ...
  return <main>
    ...
    <section className="workspace">
      ...
      <div className="table-wrap"><table><thead><tr><th>日期</th><th>人員</th><th>身分</th><th>計薪排班</th><th>打卡時間</th><th>計薪工時</th><th>預估薪資</th><th>核對狀態</th><th>備註</th><th>操作</th></tr></thead><tbody>
        ...
        {!filtered.length&&<tr><td colSpan={10} className="empty">此期間沒有符合條件的紀錄</td></tr>}
      </tbody></table></div>
